        ...
        <center>
            ...
            <div style="border: red 1px solid;padding:20px">
                ...
                <table>
                    <tr>
                        <td>Product_ID:</td>
                        <td><input type="text" name="buyproid" id="" value="<?= $rs['Product_id'] ?>" readonly></td>
                    </tr>
                    <tr>
                        <td>Product_Code:</td>
                        <td><input type="text" name="procode" id="" value="<?= $rs['Product_code'] ?>" readonly></td>
                    </tr>
                    <tr>
                        <td>Product_Name:</td>
                        <td><input type="text" name="proname" id="" value="<?= $rs['Product_Name'] ?>" readonly></td>
                    </tr>
                    <tr>
                        <td>Brand:</td>
                    ...
                    <tr>
                        <td>Quantity:</td>
                        <td><input type="number" name="quantity" id="" value="<?= $rs['Stock_Quantity'] ?>"></td>
                    </tr>
                </table><br>
                <hr><br>
